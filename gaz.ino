...
void MICS_VZ_89TE::readSensor(void) {
    ...
    readData(MICS_VZ_89TE_ADDR_CMD_GETSTATUS,MICS_VZ_89TE_ADDR_CMD_GETSTATUS_CRC, data);
...
void MICS_VZ_89TE::getVersion(void) {
    static uint8_t data[7];
    readData(MICS_VZ_89TE_DATE_CODE, MICS_VZ_89TE_DATE_CODE_CRC, data);
 ...
 *
 */
void MICS_VZ_89TE::readData(byte reg, byte crc, uint8_t data[]) {
